...
wget https://tzar-framework.googlecode.com/svn/trunk/db/update_db_schema.sql -O /tmp/update_db_schema.sql
...
psql -c "alter user tzar with password tzarpassword;"
...
psql -f /tmp/update_db_schema.sql tzar -U tzar
